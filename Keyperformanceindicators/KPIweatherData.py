...
def insert_weather_data(data, session_id):
    ...
    for i in range(len(data['Time'])):
        ...
        insert_query = """
            ...
            (time, air_temp, humidity, pressure, rainfall, track_temp, wind_direction, wind_speed, sessionid, year, circuit_name)
            VALUES
            (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);
        """
        # Include session_id as a parameter in the execute method
        cursor.execute(insert_query, (time, air_temp, humidity, pressure, rainfall, track_temp, wind_direction, wind_speed, session_id, year, circuit_name))
        conn.commit()
...
for record in records_data:
    ...
    try:
        ...
        session.load()
        insert_weather_data(session.weather_data, session_id)  # Pass session_id to the function
